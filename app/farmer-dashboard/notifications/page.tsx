...
export default function FarmerDashboardNotificationsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Farmer Notifications</h1>
          <p className="text-gray-600">
            Stay updated with your farming activities and marketplace updates
          </p>
        </div>
        {unreadCount > 0 && (
