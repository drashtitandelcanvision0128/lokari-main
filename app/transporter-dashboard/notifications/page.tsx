...
export default function TransporterDashboardNotificationsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Transporter Notifications</h1>
          <p className="text-gray-600">
            Stay updated with your transportation requests and delivery updates
          </p>
        </div>
        {unreadCount > 0 && (
