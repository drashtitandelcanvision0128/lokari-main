  ...
  const roles = [
    {
      ...
      description:
        'List your produce directly and access fair market prices with guaranteed payments.',
      icon: 'agriculture',
      color: 'primary',
    ...
    <div className="min-h-screen bg-[#f9f9f7]">
      ...
      <div className="max-w-7xl mx-auto px-8 pb-12 mt-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {roles.map((role) => (
            <Link key={role.id} href={`/register/${role.id}`} className="block group">
              <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-[#2eb5c2] hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-0.5">
                  ...
                  {role.id === 'farmer' && (
                    <>
                      <div className="flex items-center gap-1 text-xs text-gray-500">
                        <span className="material-symbols-outlined text-[#2eb5c2] text-xs">
                          check_circle
                        </span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-6 h-6 bg-gradient-to-br from-[#e89151]/10 to-[#d55b39]/10 rounded-full flex items-center justify-center group-hover:from-[#e89151]/20 group-hover:to-[#d55b39]/20 transition-colors">
                    <span className="material-symbols-outlined text-xs text-[#e89151] group-hover:translate-x-0.5 transition-transform">
                      arrow_forward
                    </span>
                  </div>
                </div>
        ...
        <div className="mt-8 bg-white rounded-xl p-6 shadow-lg">
          <div className="text-center mb-6">
            <h3 className="text-xl font-bold text-[#0b5d68] mb-2">
              Trusted by India's Agricultural Community
            </h3>
            <p className="text-gray-600 text-sm">
              Join thousands of farmers, traders, and logistics partners
            </p>
          </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-600">
            ...
            <Link
              href="/login"
              className="text-[#2eb5c2] font-semibold hover:text-[#0b5d68] transition-colors flex items-center justify-center gap-1"
            >
