...
import { createListing, getListingById, getAllListings, getListingsByUser, deleteListing, placeBid, getBidsByUser } from "../controllers/listingController.js";
// import { protect } from "../middleware/authMiddleware.js";

const router = express.Router();

router.get("/", getAllListings);         // GET  /listings
router.get("/bids/user/:userId", getBidsByUser);
